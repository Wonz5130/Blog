---
title: 实验 1.3：带表头结点单链表的逆置
tag: [线性表,实验,NJUPT]
category: 数据结构
---

>**题目：**以实验 1.2 的带表头结点单链表为存储结构，编写程序实现单链表的逆置操作 (要求不引入新的存储空间)。 
...
![](28-实验-1-3：带表头结点单链表的逆置\1.png)

<u>本文于 2018 年 5 月 26 日首发于 [CSDN](https://blog.csdn.net/Wonz5130/article/details/80460359)。</u>