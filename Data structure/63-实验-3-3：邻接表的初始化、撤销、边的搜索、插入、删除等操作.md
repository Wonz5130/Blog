---
title: 实验 3.3：邻接表的初始化、撤销、边的搜索、插入、删除等操作
tag: [图论,实验,NJUPT]
category: 数据结构
---

>**题目：**参照程序 9.6~ 程序 9.10，编写程序，完成邻接表的初始化、撤销、边的搜索、插入、删除等操作。 
...
![](63-实验-3-3：邻接表的初始化、撤销、边的搜索、插入、删除等操作\1.png)

<u>本文于 2018 年 6 月 30 日首发于 [CSDN](https://blog.csdn.net/wonz5130/article/details/80671569)。</u>	