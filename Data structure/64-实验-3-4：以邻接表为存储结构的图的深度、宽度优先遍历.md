---
title: 实验 3.4：以邻接表为存储结构的图的深度、宽度优先遍历
tag: [图论,实验,NJUPT]
category: 数据结构
---

>**题目：**以实验 3.3 所示邻接表为存储结构，编写程序，实现图的深度、宽度优先遍历。 
...
![](64-实验-3-4：以邻接表为存储结构的图的深度、宽度优先遍历\1.png)

<u>本文于 2018 年 6 月 30 日首发于 [CSDN](https://blog.csdn.net/wonz5130/article/details/80671765)。</u>	