---
title: 实验 2.1：二叉树的先序创建、先序遍历、中序遍历、后序遍历
tag: [二叉树,实验,NJUPT]
category: 数据结构
---

>**题目：**参照程序 5.1~5.4，编写程序，完成二叉树的先序创建、先序遍历、中序遍历、后序遍历等操作。 
...
![](36-实验-2-1：二叉树的先序创建、先序遍历、中序遍历、后序遍历\1.png)

<u>本文于 2018 年 5 月 27 日首发于 [CSDN](https://blog.csdn.net/Wonz5130/article/details/80470255)。</u>