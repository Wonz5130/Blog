---
title: 实验 1.2：带表头结点单链表的相关操作
tag: [线性表,实验,NJUPT]
category: 数据结构
---

>**题目：**参照程序 2.8~2.14，编写程序，完成带表头结点单链表的初始化、查找、插入、删除、输出、撤销等操作。 
...
![](27-实验-1-2：带表头结点单链表的相关操作\1.png)

<u>本文于 2018 年 5 月 26 日首发于 [CSDN](https://blog.csdn.net/Wonz5130/article/details/80460157)。</u>
