---
title: 实验 3.1：邻接矩阵的初始化、撤销、边的搜索、插入、删除等操作
tag: [图论,实验,NJUPT]
category: 数据结构
---

>**题目：**参照程序 9.1~ 程序 9.5，编写程序，完成邻接矩阵的初始化、撤销、边的搜索、插入、删除等操作。 
...
![](61-实验-3-1：邻接矩阵的初始化、撤销、边的搜索、插入、删除等操作\1.png)

<u>本文于 2018 年 6 月 30 日首发于 [CSDN](https://blog.csdn.net/Wonz5130/article/details/80670534)。</u>	